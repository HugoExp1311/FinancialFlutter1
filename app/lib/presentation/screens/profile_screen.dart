...
class ProfileScreen extends ConsumerWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                _buildCurrencySettingItem(context, ref),
  ...
  Widget _buildCurrencySettingItem(BuildContext context, WidgetRef ref) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            const Icon(Icons.attach_money_rounded, color: AppTheme.primaryColor),
            const SizedBox(width: 16),
            const Expanded(
              child: Text(
                'Currency',
